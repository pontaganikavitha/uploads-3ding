...
//     // Automatically submit order details whenever file options change
//     handleSubmitOrder();
//   };
...
//                 <th className="col-md-1 py-2">Serial No.</th>
...
//                 <th className="col-md-1 py-2">Build Volume</th>
//                 <th className="col-md-1 py-2">Total Price</th>
//               </tr>
//             </thead>
//             <tbody>
...
//                   <td className="text-center">{file.originalName}<br />{file.dimensions ? `${Math.round(file.dimensions.length)} x ${Math.round(file.dimensions.width)} x ${Math.round(file.dimensions.height)} mm` : '-'}</td>
...
//                       onChange={e =>
//                         handleOptionChange(file._id, 'quantity', parseInt(e.target.value, 10))
//                       }
//                     />
//                   </td>
//                   <td className="text-center">{file.buildVolume}</td>
//                   <td className="text-center">
//                     {calculateItemTotal(
//                       fileOptions[file._id]?.material || 'PLA',
//                       fileOptions[file._id]?.density || '20%',
...
//   // Fetching files for the session
//   const fetchFiles = async () => {
//     try {
//       const response = await fetch(`http://localhost:3001/files/${session}`);
//       const data = await response.json();
...
//                       value={fileOptions[file._id]?.quantity || 1}
//                       onChange={e =>
//                         handleOptionChange(file._id, 'quantity', parseInt(e.target.value))
//                       }
//                       min="1"
//                     />
//                   </td>
//                   <td className="text-center">
//                     {Math.round(file.buildVolume)} mm³
//                   </td>
//                   <td className="text-center">
//                     ₹{calculateItemTotal(
//                       fileOptions[file._id]?.material || 'PLA',
