...
const AddingNewFileToOrderId = () => {
    ...
    useEffect(() => {
        const fetchOptionsData = async () => {
            try {
                const response = await fetch('http://test1.3ding.in/server/options');
    ...
    const fetchOrderDetails = async (orderId) => {
        try {
            const response = await fetch(`http://test1.3ding.in/server/orders/${orderId}`);
    ...
    const handleSubmitOrder = async () => {
        try {
            ...
            const response = await fetch('http://test1.3ding.in/server/submit-order', {
                method: 'POST',
