...
const AddingNewFileToOrderId = () => {
    ...
    useEffect(() => {
        const fetchOptionsData = async () => {
            try {
                const response = await fetch('http://13.251.225.116:3001/options');
    ...
    const fetchOrderDetails = async (orderId) => {
        try {
            const response = await fetch(`http://13.251.225.116:3001/orders/${orderId}`);
    ...
    const handleSubmitOrder = async () => {
        try {
            ...
            const response = await fetch('http://13.251.225.116:3001/submit-order', {
                method: 'POST',
