...
```bash
# dev server with hot reload at http://test1.3ding.in:3002
$ npm start
```
...
Navigate to [http://test1.3ding.in:3002](http://test1.3ding.in:3002). The app will automatically reload if you change any of the source files.
