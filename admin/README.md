...
``` bash
# dev server with hot reload at http://172.31.18.216:3000
$ npm start 
```
...
Navigate to [http://172.31.18.216:3000](http://172.31.18.216:3000). The app will automatically reload if you change any of the source files.
