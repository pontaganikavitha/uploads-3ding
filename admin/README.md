...
```bash
# dev server with hot reload at http://test1.3ding.in
$ npm start
```
...
Navigate to [http://test1.3ding.in](http://test1.3ding.in). The app will automatically reload if you change any of the source files.
