...
``` bash
# dev server with hot reload at http://ec2-3-25-81-179.ap-southeast-2.compute.amazonaws.com:3000
$ npm start 
```
...
Navigate to [http://ec2-3-25-81-179.ap-southeast-2.compute.amazonaws.com:3000](http://ec2-3-25-81-179.ap-southeast-2.compute.amazonaws.com:3000). The app will automatically reload if you change any of the source files.
