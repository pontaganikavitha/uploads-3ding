...
```bash
# dev server with hot reload at http://54.66.86.34:3000
$ npm start
```
...
Navigate to [http://54.66.86.34:3000](http://54.66.86.34:3000). The app will automatically reload if you change any of the source files.
