...
const Coupens = React.lazy(() => import('./views/base/coupens/Coupens'))
...
const routes = [
  ...
  { path: '/base', name: 'Base', element: Coupens, exact: true },
  { path: '/base/accordion', name: 'Accordion', element: Accordion },
  { path: '/base/breadcrumbs', name: 'Breadcrumbs', element: Breadcrumbs },
  { path: '/base/coupens', name: 'Coupens', element: Coupens },
