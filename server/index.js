...
// //   try {
// //     const updatedFiles = files.map(file => {
// //       const effectivePrice = file.customPrice !== 0 ? file.customPrice : file.price;
// //       return {
// //         ...file,
// //         itemTotal: effectivePrice * (file.options?.quantity || 1),
...
//     // Fetch the files associated with the order
//     const files = await File.find({ orderId: req.params.orderId });

//     // Add files to the order object
//     order.files = files;
...
//     res.json(optionsData);
//   } catch (error) {
//     res.status(500).send('Error fetching options: ' + error.message);
//   }
// });
